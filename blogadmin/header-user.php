...
<html lang="en">
  ...
  <!-- Sidebar -->
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Панель администратора IT РОСХОЛОД</a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li><a href="blogs_view.php"><i class="fa fa-rss"></i>Статьи</a></li>
            <li><a href="blog_categories_view.php"><i class="fa fa-tags"></i>Категории</a></li>
            <li><a href="blogs_view.php"><i class="fa fa-check"></i>Готовые статьи</a></li>
         ...
         <ul class="nav navbar-nav navbar-right navbar-user">
            ...
            <ul class="dropdown-menu">
              <li><a href="<?php echo PREPEND_PATH; ?>membership_profile.php"><i class="fa fa-user"></i> <strong>Мой аккаунт</strong> </a></li>
 ...
 <div class="row">
          <div class="col-lg-12">
            <h1>Панель администратора, пользователь: <?php echo getLoggedMemberID(); ?> !</h1>
            <ol class="breadcrumb">
              <li><a href="../index.php"><i class="icon-dashboard" style="text-decoration:none;"></i> <strong>Перейти на сайт</strong></a></li>
              <li><a href="index.php"><i class="icon-dashboard" style="text-decoration:none;"></i> <strong>Панель администратора</strong></a></li>
            </ol>
