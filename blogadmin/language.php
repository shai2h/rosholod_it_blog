<?php
	...
	$Translation['Add New'] = 'Добавить новую статью';
	$Translation['Delete'] = 'Удалить';
	$Translation['Cancel'] = 'Отмена';
	$Translation['Print Preview'] = 'Предпросмотр печати';
	$Translation['Save Changes'] = 'Сохранить изменения';
	$Translation['CSV'] = 'Сохранить таблицу';
	$Translation['Reset Filters'] = 'Показать всё';
	$Translation['Find It'] = 'Поиск';
	$Translation['Previous'] = 'Предыдущий';
	$Translation['Next'] = 'Вперёд';
	$Translation['Back'] = 'Назад';

	// lib.php
	$Translation['select a table'] = "Перейти к..";
	...
	// separateDVTV.php
	$Translation['please wait'] = "Загрузка";

	// _view.php
	$Translation['tableAccessDenied']="Sorry! You don't have permission to access this table. Please contact the admin.";

	// incCommon.php
	$Translation['not signed in']="Вы не вошли";
	$Translation['sign in']="авторизация";
	$Translation['signed as']="Пользователь: ";
	...
	// index.php
	$Translation['admin area']="Админ панель";
	...
	$Translation['username']="Логин";
	$Translation['password']="Пароль";
	$Translation['go to signup']="Нет зарегистрированы? <br />&nbsp; <a href=membership_signup.php>Регистрация</a>";
	...
	$Translation['no table access']="У вас недостаточно прав для доступа к любой странице здесь. Пожалуйста, войдите сначала в систему.";
	$Translation['signup']="Регистрация";
	...
	$Translation['sign up']="Регистрация";
