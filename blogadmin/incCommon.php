	...
	*/
	...
	function getTableList($skip_authentication = false){
		...
		$arrTables = array(
			...
			'titles' => array('Детали', '', 'resources/table_icons/drugs_com.png', 'None'),
			'links' => array('Ссылка', '', 'resources/table_icons/firefox.png', 'None'),
			'blog_categories' => array('Категории', '', 'resources/table_icons/award_star_bronze_2.png', 'None'),
			'blogs' => array('Статьи', '', 'resources/table_icons/feed.png', 'None'),
			'editors_choice' => array('Редактор', '', 'resources/table_icons/bullet_star.png', 'None')
		);
	...
	function htmlUserBar(){
		...
		<nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo PREPEND_PATH; ?>index.php"><i class="glyphicon glyphicon-home"></i> Панель администратора</a>
			</div>
