<?php
	...
	$Translation['upload image'] = 'Загрузить изображение ';
	$Translation['select image'] = 'Выбрать изображение ';
	$Translation['remove image'] = 'Удалить изображение';
	$Translation['month names'] = 'January,February,March,April,May,June,July,August,September,October,November,December';
	$Translation['field not null'] = 'Вы не можете оставить поле пустым';
	$Translation['*'] = '*';
	$Translation['today'] = 'Сегодня';
	$Translation['Hold CTRL key to select multiple items from the above list.'] = 'Удерживайте клавишу CTRL, чтобы выбрать несколько элементов из приведенного выше списка.';
	$Translation['Save New'] = 'Сохранить';
	$Translation['Save As Copy'] = 'Сохранить как копию';
	$Translation['Deselect'] = 'Отмена';
	$Translation['Add New'] = 'Добавить';
	$Translation['Delete'] = 'Удалить';
	$Translation['Cancel'] = 'Отменить';
	$Translation['Print Preview'] = 'Просмотр печати';
	$Translation['Save Changes'] = 'Сохранить изменения';
	$Translation['CSV'] = 'Сохранить в CSV';
	$Translation['Reset Filters'] = 'Показать всё';
	$Translation['Find It'] = 'Найти';
	$Translation['Previous'] = 'Предыдущее';
	$Translation['Next'] = 'Следующее';
	$Translation['Back'] = 'Назад';

	// lib.php
	$Translation['select a table'] = "Перейти в ..";
	$Translation['homepage'] = "Главная";
	...
	// setup.php
	$Translation['goto start page'] = "Вернуться на главную";
	...
	// index.php
	$Translation['admin area']="Панель админа";
	$Translation['login failed']="Ваша предыдущая попытка входа не удалась. Попробуйте еще раз.";
	$Translation['sign in here']="Войти";
	$Translation['remember me']="Запомнить меня";
	$Translation['username']="Никнейм";
	$Translation['password']="Пароль";
	$Translation['go to signup']="Нет аккаунта? <br>&nbsp; <a href=membership_signup.php>Зарегистрируйтесь</a>";
	$Translation['forgot password']="Забыли пароль? <a href=membership_passwordReset.php>Нажмите сюда</a>";
	$Translation['browse as guest']="<a href=index.php>Продолжить, как гость?</a>";
	$Translation['no table access']="У вас недостаточно прав для доступа к любой странице здесь. Сначала войдите в систему.";
	$Translation['signup']="Войти";

	// checkMemberID.php
	$Translation['user already exists']="Имя '<MemberID>' уже используется. попробуйте другое.";
	$Translation['user available']="Имя '<MemberID>' доступно.";
	$Translation['empty user']="Сначала введите имя пользователя в поле, затем нажмите «Проверить доступность».";
	...
	$Translation['password reset']="Восстановление пароль";
	...
	$Translation['Table'] = 'Таблицы';
	$Translation['Edit'] = 'Редактировать';
	$Translation['View'] = 'Просмотр';
